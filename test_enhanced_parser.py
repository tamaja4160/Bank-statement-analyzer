#!/usr/bin/env python3
"""
Test script to verify the enhanced bank statement parser works on sample images.
"""
...
def test_enhanced_parser_on_samples():
    """Test the enhanced parser on a few sample images."""
    ...
    print("🧪 Testing Enhanced Bank Statement Parser on Sample Images...")
    ...
    for image_name in sample_images:
        ...
        if os.path.exists(image_path):
            print(f"\n📄 Enhanced testing {image_name}...")
            
            # Parse single statement with enhanced processing
    ...
    print("🏁 Enhanced sample testing completed!")

if __name__ == "__main__":
    test_enhanced_parser_on_samples()
